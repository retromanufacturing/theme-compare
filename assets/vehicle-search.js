...
class VehicleSelector extends HTMLElement  { 
  ...
  connectedCallback() {  
    this.yearSelect = document.querySelector('.js-ymm--year')
    this.makeSelect  = document.querySelector('.js-ymm--make')
    this.modelSelect  = document.querySelector('.js-ymm--model')
    this.searchBtn = document.querySelector(".js-ymm--search")
    this.resetBtn = document.querySelector(".js-ymm--reset")
